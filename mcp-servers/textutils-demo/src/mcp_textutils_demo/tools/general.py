"""general tools for textutils-demo."""
...
def register_tools(server: FastMCP, _get_backend) -> None:
    ...
    async def checksum(
        ...
        # Call function via CLI backend: textutils.py::checksum
    ...
    async def count(
        ...
        # Call function via CLI backend: textutils.py::count
        return await _get_backend().run_function_as_cli(
            "textutils.py",
            "count",
            text=text,
    ...
    async def lowercase(
        ...
        # Call function via CLI backend: textutils.py::lowercase
        return await _get_backend().run_function_as_cli(
            "textutils.py",
            "lowercase",
            text=text,
    ...
    async def reverse(
        ...
        # Call function via CLI backend: textutils.py::reverse
        return await _get_backend().run_function_as_cli(
            "textutils.py",
            "reverse",
            text=text,
    ...
    async def slugify(
        ...
        # Call function via CLI backend: textutils.py::slugify
        return await _get_backend().run_function_as_cli(
            "textutils.py",
            "slugify",
            text=text,
    ...
    async def uppercase(
        ...
        # Call function via CLI backend: textutils.py::uppercase
        return await _get_backend().run_function_as_cli(
            "textutils.py",
            "uppercase",
            text=text,
