...
class Backend:
    """Communicates with weather-demo via command-line interface."""

    def __init__(self) -> None:
        self.codebase_path = Path("/Users/selfsim/projects/mcp-demo/demos/weather")
        self.entry_command = "python /Users/selfsim/projects/mcp-demo/demos/weather/weather.py"
