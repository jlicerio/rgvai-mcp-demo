"""general tools for weather-demo."""
...
def register_tools(server: FastMCP, _get_backend) -> None:
    ...
    async def cmd_compare(
        ...
        """Cmd compare"""
        # Call function via CLI backend: weather.py::cmd_compare
    ...
    async def cmd_current(
        ...
        """Cmd current"""
        # Call function via CLI backend: weather.py::cmd_current
        return await _get_backend().run_function_as_cli(
            "weather.py",
            "cmd_current",
            args=args,
    ...
    async def cmd_forecast(
        ...
        """Cmd forecast"""
        # Call function via CLI backend: weather.py::cmd_forecast
        return await _get_backend().run_function_as_cli(
            "weather.py",
            "cmd_forecast",
            args=args,
